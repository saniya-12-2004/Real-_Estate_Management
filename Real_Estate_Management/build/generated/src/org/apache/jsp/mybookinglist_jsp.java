...
public final class mybookinglist_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("            \n");
      out.write("            <center><h2><b>My Booking</b></h2></center>\n");
      out.write("            <br>\n");
       ...
       try
    {
       ...
       cn=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_realestate", "root", "root");
        ...
        String sql="select * from tbl_booking where uid='"+session.getAttribute("uid")+"'";
